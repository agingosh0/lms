    ...
    <div className="!flex h-[55vh] w-full items-center justify-between px-10">
      ...
      <div className="container mx-auto mt-28">
        <div className="grid grid-cols-12 text-center lg:text-left">
          <Card className="col-span-full rounded-xl border border-white bg-white/90 py-10 p-8 shadow-lg shadow-black/10 backdrop-blur-sm backdrop-saturate-200 xl:col-span-7" {...({} as any)}>
            <Typography
              variant="h1"
              color="blue-gray"
            ...
            <Typography variant="lead" className="mb-10 mt-6 !text-gray-900" {...({} as any)}>
            ...
            <div className="mb-8 flex justify-center gap-4 lg:justify-start">
              <Button color="gray" {...({} as any)}>view all courses</Button>
              <Button color="gray" variant="outlined" {...({} as any)}>
                see pricing
              </Button>
            </div>
